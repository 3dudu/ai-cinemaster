          ...
          <div className="max-h-[50vh] overflow-y-auto rounded-lg px-4"> 
           <div>
             ...
             <div className="relative">
               <input
                 ...
                 className="w-full bg-slate-800 border border-slate-600 text-slate-50 px-4 py-2 pr-10 text-sm rounded-lg focus:border-slate-500 focus:outline-none transition-all font-mono placeholder:text-slate-400"
               />
               <button
                 type="button"
           ...
           <div>
             ...
             <input
               ...
               className="w-full bg-slate-800 border border-slate-600 text-slate-50 px-4 py-2 text-sm rounded-lg focus:border-slate-500 focus:outline-none transition-all font-mono placeholder:text-slate-400"
             />
             <p className="mt-3 text-[12px] text-slate-400 leading-relaxed">
           ...
           <button
             ...
             className="w-full py-3 bg-slate-800 text-slate-300 font-bold uppercase tracking-widest text-xs rounded-lg hover:bg-slate-700 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
           >
