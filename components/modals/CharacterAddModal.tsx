    ...
    >
      <div className="bg-slate-800 border border-slate-600 rounded-2xl w-[600px] max-w-[90vw] max-h-[85vh] overflow-hidden shadow-2xl flex flex-col select-text">
        ...
        <div className="flex-1 overflow-y-auto p-2 md:p-6 space-y-5 bg-slate-700">
          ...
          {/* 年龄 */}
          <div className="space-y-2">
            <label className="text-[12px] font-bold text-slate-500 uppercase tracking-widest">年龄</label>
            <input
              type="text"
              value={formData.age}
          ...
          {/* 性格特点 */}
          <div className="space-y-2">
            <label className="text-[12px] font-bold text-slate-500 uppercase tracking-widest">性格特点</label>
            <textarea
          ...
          {/* 视觉提示 */}
          <div className="space-y-2">
            <label className="text-[12px] font-bold text-slate-500 uppercase tracking-widest">视觉提示</label>
            <div className="relative">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-2 bg-slate-800/65 backdrop-blur-sm border-t border-slate-600/50 rounded-b-md flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-slate-600 hover:bg-slate-500 text-slate-50 text-[11px] font-bold uppercase tracking-wider rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1.5 cursor-pointer"
                  title="AI生成视觉提示"
                >
                  {isGeneratingPrompt ? (
        ...
        <div className="p-6 bg-slate-600/80 border-t border-slate-600 flex gap-3 shrink-0">
          ...
          <button
            ...
            className={`flex-1 py-3 text-[11px] font-bold uppercase tracking-wider rounded-lg transition-colors cursor-pointer ${
              isEditMode
