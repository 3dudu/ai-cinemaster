            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-slate-800 border border-slate-600 text-slate-50 px-3 py-2.5 pr-10 text-sm rounded-md focus:border-slate-500 focus:outline-none transition-all font-mono placeholder:text-slate-600"
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-slate-800 border border-slate-600 text-slate-50 px-3 py-2.5 text-sm rounded-md focus:border-slate-500 focus:outline-none transition-all font-mono placeholder:text-slate-600"
