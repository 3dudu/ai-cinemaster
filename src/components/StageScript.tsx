              ...
              {localDuration === 'custom' && (
                <div>
                  <input
                    ...
                    className="w-full bg-slate-800 border border-slate-600 text-slate-50 px-4 py-2 text-[11px] rounded-md focus:border-slate-500 focus:outline-none font-mono placeholder:text-slate-600"
