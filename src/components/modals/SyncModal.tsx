      ...
      <div className="bg-slate-800 border border-slate-600 w-full max-w-2xl max-h-[85vh] rounded-2xl flex flex-col shadow-2xl overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={isLoading}
                className="py-2 px-6 bg-slate-800 text-slate-300 font-bold tracking-widest text-xs rounded-lg hover:bg-slate-600 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                >
                  {isLoading ? (
                          ...
                          <>
                            {isServerOnly ? (
                              <button
                                ...
                                disabled={isLoading}
                                className="py-1.5 px-3 rounded text-[10px] font-bold tracking-wider transition-colors cursor-pointer flex items-center gap-1 border border-slate-400 bg-slate-600 text-slate-500 hover:bg-slate-700"
                              >
                              ...
                              <button
                                ...
                                className={`py-1.5 px-3 rounded text-[10px] font-bold tracking-wider transition-colors cursor-pointer flex items-center gap-1 ${
        ...
        <div className="px-6 py-2 border-t border-slate-600 flex items-center justify-between gap-3 shrink-0 bg-slate-600/80">
          ...
          <button
            ...
            className="py-3 px-6 bg-slate-800 text-slate-300 font-bold tracking-widest text-xs rounded-lg hover:bg-slate-700 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
          >
            <RefreshCw className="w-4 h-4" />
            <span>确认同步</span>
          </button>
