...
const PromptTemplateModal: React.FC<{
  ...
  const templates: Template[] = useMemo(() => [
    { key: 'SYSTEM_SEGMENT_DESIGNER', name: '🤖 片段模式-系统提示词-片段拆分系统设定', description: ' 系统设定，片段拆分系统设定', hasParams: true },
    { key: 'SYSTEM_SEGMENT_TRANSLATE', name: '🤖 片段模式-导演提示词-片段视频转场设定', description: ' 为单个片段生成视频转场提示词', hasParams: true },
    { key: 'SYSTEM_SEGMENT_SPLIT', name: '🤖 片段模式-系统提示词-直接剧本拆分片段提示词', description: ' 导演系统提示词-导演直接剧本拆分片段', hasParams: true },
    { key: 'SYSTEM_SCRIPT_ANALYZER', name: '🤖 分镜模式-剧本分析员系统提示词-分析剧本', description: ' 用于剧本解析的系统提示词' },
    { key: 'SYSTEM_PHOTOGRAPHER', name: '🤖 分镜模式-摄影师系统提示词-分镜', description: ' 用于镜头清单生成的系统提示词' },
    { key: 'SYSTEM_CHARA_DESIGNER', name: '🤖 分镜模式-角色设计师系统提示词', description: ' 用于角色提示词生成的系统提示词' },
    { key: 'SYSTEM_SCENE_DESIGNER', name: '🤖 分镜模式-场景设计师系统提示词', description: ' 用于场景提示词生成的系统提示词' },
    { key: 'SYSTEM_VIDEO_DIRECTOR', name: '🤖 分镜模式-导演系统提示词', description: ' 用于视频拍摄提示词生成的系统提示词' },
    { key: 'SYSTEM_SCRIPT_IMPORTER', name: '🤖 导入模式-影视策划系统提示词', description: ' 用于规划拍摄场景角色的系统提示词' },
    { key: 'SYSTEM_SCREENWRITER', name: '🤖 编剧系统提示词-写剧本', description: ' 用于剧本生成的系统提示词' },
    { key: 'GENERATE_SEGMENT_PROMPT', name: '📋 片段模式-导演-片段视频文字分镜提示词润色', description: ' 导演-片段视频文字分镜提示词润色', hasParams: true },
    ...
    { key: 'GENERATE_SEGMENT_VIDEO_PROMPT', name: '🎨 片段模式-导演-片段视频最终生成提示词', description: ' 导演-片段视频最终生成', hasParams: true },
    ...
    { key: 'GENERATE_SEGMENTS_FROM_SCRIPT', name: '✨ 片段模式-导演-剧本一键拆分片段-结构化输出', description: ' 导演-剧本一键拆分片段提示词，保持原样', hasParams: true },
    { key: 'AI_SPLIT_SEGMENTS', name: '✨ 片段模式-导演-结合分镜拆分片段提示词-结构化输出', description: ' 根据分镜自动拆分片段，加入AI加工', hasParams: true },
    { key: 'PARSE_SCRIPT', name: '✨ 剧本分析员-剧本解析提示词-结构化输出', description: ' 解析原始文本提取剧本信息，角色，场景，故事线', hasParams: true },
    { key: 'GENERATE_SHOTS', name: '✨ 摄影师-分镜-镜头清单生成提示词-结构化输出', description: ' 分镜-生成场景的镜头调度设计', hasParams: true },
    { key: 'IMPORT_SCRIPT', name: '✨ 导入模式-策划师-剧本导入提示词-结构化输出', description: ' 导入原始剧本，提取剧集基本信息', hasParams: true },
    { key: 'IMPORT_SHOTS', name: '✨ 导入模式-策划师-镜头清单导入提示词-结构化输出', description: ' 导入场景的镜头调度设计', hasParams: true },
    { key: 'IMPORT_SHOTS_FOR_SCENE', name: '✨ 导入模式-策划师-特定场景镜头清单导入提示词-结构化输出', description: ' 导入场景的镜头调度设计', hasParams: true },
  ], []);
