    ...
    <div className="absolute inset-0 z-50 bg-slate-900/80 backdrop-blur-sm flex items-center justify-center p-8 animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="p-6 space-y-4">
          {/* 图片标题 */}
          <div>
            <h4 className="text-sm font-bold text-slate-50 tracking-widest mb-2">图片标题</h4>
          ...
          {timestamp && (
            <div>
              <h4 className="text-sm font-bold text-slate-50 tracking-widest mb-2">生成时间</h4>
              <p className="text-sm text-slate-300 bg-slate-900/50 rounded-lg p-3 border border-slate-700">
          ...
          {/* 提示词内容 */}
          <div>
            <h4 className="text-sm font-bold text-slate-50 tracking-widest mb-2">提示词内容</h4>
            <textarea
              readOnly
              value={prompt}
