/**
 * 内置提示词模版组配置
 * 包含 default、真人写实、古风/仙侠、3D动画 四个预置组
 */

import { PromptTemplateGroup } from '../types/promptTemplate';

/**
 * 默认模版组 - 包含全部 10 个模板的完整内容
 * 作为所有风格组的降级兜底
 */
export const DEFAULT_TEMPLATE_GROUP: PromptTemplateGroup = {
  id: 'default',
  name: '默认组',
 ...
 * 针对真人写实风格优化的模版
 */
export const REALISTIC_TEMPLATE_GROUP: PromptTemplateGroup = {
  id: 'realistic',
  name: '真人写实',
 ...
 * 针对中国古风、仙侠题材优化的模版
 */
export const ANCIENT_CHINESE_TEMPLATE_GROUP: PromptTemplateGroup = {
  id: 'ancient-chinese',
  name: '古风/仙侠',
 ...
 * 针对3D动画、卡通风格优化的模版
 */
export const THREE_D_ANIMATION_TEMPLATE_GROUP: PromptTemplateGroup = {
  id: '3d-animation',
  name: '3D动画',
 ...
 * 所有内置模版组
 */
export const BUILT_IN_TEMPLATE_GROUPS: PromptTemplateGroup[] = [
  DEFAULT_TEMPLATE_GROUP,
  REALISTIC_TEMPLATE_GROUP,
  ANCIENT_CHINESE_TEMPLATE_GROUP,
  THREE_D_ANIMATION_TEMPLATE_GROUP,
];
